...
<head>
    <meta charset="UTF-8">
    <title>Welcome to CodeIgniter 4! com PostgreSql</title>
    <meta name="description" content="The small framework with powerful features">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="shortcut icon" type="image/png" href="img/logoaondenet.png">
    <link rel="stylesheet" href="/css/welcome_message.css">
...
<header>
  <div class="menu fixed-top">
    <ul class="nav nav-tabs" id="myTab" role="tablist">
      ...
      <li class="nav-item">
        <a class="nav-link" id="messages-tab" data-toggle="tab" href="/home" role="tab" aria-controls="messages" aria-selected="false">Home new</a>
      </li>
      <li class="nav-item">
...
<section class="heroe title-news">
